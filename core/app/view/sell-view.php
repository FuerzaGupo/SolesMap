<div class="row">
	<div class="col-md-12">
	<h1>Realizar Gasto</h1>
	<p><b>Buscar Categoría por nombre o por codigo:</b></p>
		<form id="searchp">
		<div class="row">
			<div class="col-md-6">
...
<tr >
	...
	<td><?php echo $product->name; ?></td>
	<td >S/. <?php echo number_format($p["q"],2,'.',','); ?></td>
	<td></td>
...
<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Categoría de Salida</label>
    <div class="col-lg-10">
    <?php 
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        ...
        <button class="btn btn-lg btn-primary"><i class="glyphicon glyphicon-usd"></i><i class="glyphicon glyphicon-usd"></i> Realizar Gasto</button>
        </label>
      </div>
    </div>
  </div>
