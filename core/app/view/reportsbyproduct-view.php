<div class="row">
	<div class="col-md-12">
	<a href="index.php?view=addproduct" class="btn btn-primary pull-right">Agregar Categoría Ingreso</a>
		<h1>Reporte por Categorías</h1>
		<p class="alert alert-success">Debe seleccionar una Categoría para visualizar su reporte.</p>
